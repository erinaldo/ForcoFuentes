...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.SetBounds(1, 1, 1200, 300)                   'Pone la forma Form1.vbp en una forma centrada en la pantalla
    ...
    Private Sub MostrarTiquetes()
        Dim ds As DataSet
        strSQL = "SELECT * FROM vw_FE_Control WHERE TipoDoc_Id = 1 and estado = 0 and status_code is null and Clave_Unica_FE is not null"
        ds = funFillDataSet(strSQL)
        Me.lblContadorShoppersMundoMagico.Text = "Registros a Procesar Facturacion Mundo Mágico y Shoopers: " + CStr(ds.Tables("Tabla").AsDataView.Count)
    End Sub
