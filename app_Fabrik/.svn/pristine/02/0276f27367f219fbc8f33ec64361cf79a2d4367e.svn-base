...
Public Class frmRepPro_Open
    ...
    Private Sub frmRepPro_Open_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
    End Sub
