...
Public Class frmBuscar
    ...
    Private Sub frmBuscar_Seek_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        '--
    ...
    Private Sub frmBuscar_Seek_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        '--
        bolFound = False
        '--
        bolTipoBusqueda = False
