...
Public Class frmRepMovimientos
    ...
    Private Function funCargaCombos()
        ...
        '-- Carga Conceptos de Inventario
        strSQL = clsCombos.funGetLkConceptoInventarioAll()
