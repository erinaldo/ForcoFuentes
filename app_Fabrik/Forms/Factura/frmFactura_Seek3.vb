...
Public Class frmFactura_Seek3
    ...
    Private Sub frmFactura_Seek3_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        '--
    ...
    Private Sub frmFactura_Seek3_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        '--
        bolFound = False
        '--
        bolTipoBusqueda = False
    ...
    Private Function funUpdateGrid() As Boolean
        ...
        funSetColumna(Me.gvProducto, "mPrecio_Venta1", "P.Detalle", funIndice(), 100, 1, , , "n2", 3, , DevExpress.Utils.FormatType.Numeric)
        '--
        Return True
    End Function
    ...
    Private Sub gvProducto_Click(sender As System.Object, e As System.EventArgs) Handles gvProducto.Click
        ...
        '-- 17-11-2017
        cbPrecio.Value = Me.gvProducto.GetFocusedRowCellValue("mPrecio_Venta1")
        '--
    End Sub
