...
Public Class frmFacturaEx_Data
    ...
    Private Sub frmFacturaEx_Data_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        bolInicio = True
        If nTipo = 1 Then
            funCargaCombos()
            funUpdateGrid()
    ...
    Private Function Validar() As Boolean
        ...
        If nTipo = 1 Then
            ...
            strSQL = "SELECT * " &
                        ...
                        "WHERE strReferencia = '" & Trim(Me.txtReferencia.Text) & "' " &
    ...
    Private Sub funCargaDataCliente()
        '-- GB-2012-01-12: Filtramos el registro de la cabezera
        ...
        If ds.Tables("Tabla").Rows.Count >= 1 Then
            '-- Cargamos datos
            Me.txtTelefono.Text = ds.Tables("Tabla").Rows(0)("strTelefono").ToString
            Me.txtDireccion.Text = ds.Tables("Tabla").Rows(0)("strDomicilio").ToString
        Else
            MsgBox("No Existen Registros ... !!!", MsgBoxStyle.Critical, "Información")
        End If
        '--
