...
Public Class frmMain
    ...
    Private Sub nav2EntradaPro_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2EntradaPro.LinkClicked
        '-- Entrada de Insumos
        strTitulo = "Entrada Insumos"
        vnTipoAjuste = 13
        Me.MostrarForm(My.Forms.frmAjustePro_Open)
    End Sub

    Private Sub nav2SalidaInsumos_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2SalidaPro.LinkClicked
        '-- Salida de Insumos
        strTitulo = "Salida Insumos"
        vnTipoAjuste = 14
        Me.MostrarForm(My.Forms.frmAjustePro_Open)
    End Sub

    Private Sub nav2EntradaPT_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2EntradaPT.LinkClicked
        '-- Salida de Insumos
        strTitulo = "Producto Terminado"
        vnTipoAjuste = 15
        Me.MostrarForm(My.Forms.frmAjustePro_Open)
    End Sub
    ...
    Private Sub nav2Ventas_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Ventas.LinkClicked
        '-- Reporte de ventas
        'strTitulo = "Producto Terminado"
        'vnTipoAjuste = 15
        Me.MostrarForm(My.Forms.frmRepVentas_Open)
    End Sub

    Private Sub nav2Compras_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Compras.LinkClicked
        Me.MostrarForm(My.Forms.frmRepCompras_Open)
    End Sub

    Private Sub nav2Pro_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Pro.LinkClicked
        Me.MostrarForm(My.Forms.frmRepPro_Open)
    End Sub

    Private Sub nav2Margen_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Margen.LinkClicked
        Me.MostrarForm(My.Forms.frmRepMargen_Open)
    End Sub
    ...
    Private Sub nav2FacturaEx_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2FacturaEx.LinkClicked
        '-- Me.MostrarForm(My.Forms.frmFactura_Open)
        '-- Me.MostrarForm(My.Forms.frmSalida_Open)
        '-- vnTipoSalida = 11
        vnTipoSalida = 9
        Me.MostrarForm(My.Forms.frmFacturaEx_Open)
    End Sub

    Private Sub nav2Test_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Test.LinkClicked
        '-- Pruebas Paletas
        strTitulo = "Paletas Pruebas"
        vnTipoAjuste = 17
        Me.MostrarForm(My.Forms.frmAjustePro_Open)
    End Sub

    Private Sub nav2Cierre_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles nav2Cierre.LinkClicked
        Me.MostrarForm(My.Forms.frmRepCierre)
    End Sub

    Private Sub frmMain_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        If intEmpresa = 1 Then
            Me.nav2Orden.Enabled = False
            Me.navEntrada.Visible = True
            Me.navFactura.Visible = True
            Me.navInventario.Visible = True
            Me.navCatalogo.Visible = True
            Me.nav2EntradaPro.Enabled = False
            Me.nav2EntradaPT.Enabled = True
            Me.nav2Inicial.Enabled = False
            Me.nav2Receta.Enabled = True
        ...
        Else
            ...
            Me.nav2Inicial.Enabled = False
            Me.nav2Receta.Enabled = False
            ''Me.nav2SalidaPro.Enabled = False
            'Me.navEntrada.Visible = False
            'Me.navFactura.Visible = False
            'Me.navInventario.Visible = False
            'Me.nav2EntradaPT.Enabled = False
            'Me.navCatalogo.Visible = False
        End If
    End Sub
End Class
