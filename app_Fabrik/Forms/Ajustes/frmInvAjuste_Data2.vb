...
Public Class frmInvAjuste_Data2
    ...
    Private Sub funUpdateGrid()
        ...
        'funSetColumna(gvDetalle, "nCantidad2", "Cant2", funIndice(), 100, 1, , , "n2", 3, , DevExpress.Utils.FormatType.Numeric)
    ...
    Private Sub funCargaGrid()
        ...
        With Me.gvDetalle
            ...
            '.SetFocusedRowCellValue(.Columns("nCantidad2"), funNull2Val(vnCantidad2))
    ...
    Function funGrabarDetalle()
        ...
        For i = 0 To Me.gvDetalle.RowCount - 1
            ...
            'funAddCampo("nCantidad2", Me.gvDetalle.GetDataRow(i)("nCantidad2"), 0)
    ...
    Private Sub subAdd()
        Dim f As New frmInvAjuste_Seek2
