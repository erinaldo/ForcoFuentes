...
Public Class frmRepCertExisteItem
    ...
    Private Sub frmRepCertExisteItem_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepCertExisteItem_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
    End Sub
    ...
    Private Function funImprimir()
        ...
        funPrintConSp("repCertExisteItem.rpt", lstParametros)
        '--
        Return True
    End Function
