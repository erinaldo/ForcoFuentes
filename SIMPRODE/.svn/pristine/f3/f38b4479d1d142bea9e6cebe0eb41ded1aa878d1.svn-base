Public Class frmPrincipal
    ...
    Private Sub ReporteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteToolStripMenuItem.Click
        ...
        llama_despliegue()
        'Dim f As New frmRepExistencia2
    ...
    Private Sub JFacturasToolStripMenuItem_Click(sender As Object, e As EventArgs) 
    ...
    Private Sub ToolStripMenuItem17_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem17.Click
        'rutareporte = rutaVentas & "ReporteMargendeVentasDetallado.rpt"
        'llama_despliegue()
        Dim f As New frmRepVentasDetalle2
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub ComprasLocalesXProveedorToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ComprasLocalesXProveedorToolStripMenuItem.Click
        Dim f As New frmRepProveedorVence
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub VentasAlDetallXSucursalYDeptoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VentasAlDetallXSucursalYDeptoToolStripMenuItem.Click
        Dim f As New frmRepVentasDetalleSuc
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub GuiasXSucYCostoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GuiasXSucYCostoToolStripMenuItem.Click
        Dim f As New frmRepGuias
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub
    Private Sub VetnasXSucursalYCaegoriaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VetnasXSucursalYCaegoriaToolStripMenuItem.Click
        Dim f As New frmRepVentasDetalleCat
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub VentasAlDetalleXClienteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VentasAlDetalleXClienteToolStripMenuItem.Click
        Dim f As New frmRepVentasDetalle_Cliente
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub ComprometidosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ComprometidosToolStripMenuItem.Click
        Dim f As New frmComprometidos
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub AnalisarArticuloToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisarArticuloToolStripMenuItem.Click
        Dim f As New frmAnalisis
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub ExistenciaCategoriaCEDI_Click(sender As Object, e As EventArgs) Handles ExistenciaCategoriaCEDI.Click
        rutareporte = rutainventario & "ReporteExistenciasXCategoriaXCEDI.rpt"
        llama_despliegue()
    End Sub

    Private Sub ShoppersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ShoppersToolStripMenuItem.Click
        Dim f As New frmRepDepto3_SH
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub TrasladosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TrasladosToolStripMenuItem.Click
        Dim f As New frmTraslados_Open
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub TrasladoSINUBICACIONToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TrasladoSINUBICACIONToolStripMenuItem.Click
        'Dim f As New frmTraslados_SIN
        'f.StartPosition = FormStartPosition.CenterScreen
        'f.ShowDialog()
    End Sub

    Private Sub AjusteEntradaUBICACIONToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AjusteEntradaUBICACIONToolStripMenuItem.Click
        Dim f As New frmTraslados_Entrada
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub

    Private Sub TrasladosRACKToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TrasladosRACKToolStripMenuItem.Click
        Dim f As New frmTraslados_Local
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()
    End Sub
End Class