...
Public Class frmRepExistencia
    ...
    Private Sub frmRepExistencia_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmRepExistencia_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
        funUpdateGrid_Suc()
    End Sub
