...
Public Class frmRepVentasDetalle_Cliente
    '--
    ...
    Private Sub frmRepVentasDetalle_Cliente_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepVentasDetalle_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid_Depto()
        funUpdateGrid_Suc()
    End Sub
    ...
    Private Sub funUpdateGrid_Datos()
        ...
        Try
            ...
            indice = 0
            '--
            funSetColumna(gvDetalle2, "TIPO_CLIENTE", "T.CLIENTE", funIndice(), 90, 1)
            ...
            funSetColumna(gvDetalle2, "ESTADO", "ACTIVO", funIndice(), 80, 1)
            funSetColumna(gvDetalle2, "U.BULTO", "U.BULTO", funIndice(), 90, 1)
            funSetColumna(gvDetalle2, "U.INTERNA", "U.INTERNA", funIndice(), 90, 1)
            ...
            funSetColumna(gvDetalle2, "EXISTENCIA_CEDI", "EXISTENCIA_CEDI", funIndice(), 100, 1, , , "n0", 0, , DevExpress.Utils.FormatType.Numeric)
            funSetColumna(gvDetalle2, "COSTO_ACTUAL", "COSTO_ACTUAL", funIndice(), 100, 1, , , "n2", 3, , DevExpress.Utils.FormatType.Numeric)
            funSetColumna(gvDetalle2, "PRECIO_DETALLE", "PRECIO_DETALLE", funIndice(), 100, 1, , , "n0", 0, , DevExpress.Utils.FormatType.Numeric)
    ...
    Private Sub funCargaData2()
        '--
        Dim nClientePrecio As Integer

        If Me.optOpcion.SelectedIndex = 0 Then
            nClientePrecio = nClientePrecio + 1
        ElseIf Me.optOpcion.SelectedIndex = 1 Then
            nClientePrecio = nClientePrecio + 2
        End If

        '-- Procesamos el SP, para cargar datos
        Dim CMD As New SqlCommand("sp_RepVentasDetalle2_Test_Cliente")
        '--
        ...
        CMD.Parameters.Add("@tipoprecio", SqlDbType.Int).Value = nClientePrecio
        '--
