...
Public Class frmTraslados_Local
    ...
    Private Sub frmTraslados_Local_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'funCargaData()
    End Sub
    ...
    Private Sub bbProceso_Click(sender As Object, e As EventArgs) Handles bbProceso.Click
        ...
        funGrabarOrigen()
        funGrabarDestino()
        clsTraslado.funGetTrasladoLocal(Trim(Me.txtTraslado.Text))
        '--
    End Sub
