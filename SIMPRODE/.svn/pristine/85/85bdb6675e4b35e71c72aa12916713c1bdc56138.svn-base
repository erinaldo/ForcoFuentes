...
Public Class frmRepExistencia2
    '--
    ...
    Private Sub frmRepExistencia2_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepExistencia2_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid_Depto()
        funUpdateGrid_Suc()
    End Sub
