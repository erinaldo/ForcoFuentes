...
Public Class frmRepVentasDetalle2
    '--
    ...
    Private Sub frmRepVentasDetalle2_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepVentasDetalle2_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid_Depto()
        funUpdateGrid_Suc()
    End Sub
    ...
    Private Function funUpdateGrid_Suc()
        Try
            ds = clsSucursal.funListaSucursal2()
    ...
    Private Sub funUpdateGrid_Datos()
        ...
        Try
            ...
            funSetColumna(gvDetalle2, "PRECIO_DETALLE_CON_IVI", "PRECIO_DETALLE_CON_IVI", funIndice(), 100, 1, , , "n0", 0, , DevExpress.Utils.FormatType.Numeric)
            ...
            funSetColumna(gvDetalle2, "IMPUESTO", "IMPUESTO", funIndice(), 100, 1)
    ...
    Private Sub funCargaData2()
        ...
        Dim CMD As New SqlCommand("sp_RepVentasDetalle2_Shp")
        '--
