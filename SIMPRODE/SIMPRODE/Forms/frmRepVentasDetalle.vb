...
Public Class frmRepVentasDetalle
    '--
    ...
    Private Sub frmRepVentasDetalle_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub funCargaData2()
        ...
        Dim CMD As New SqlCommand("sp_RepVentasDetalle2_Test")
        '--
