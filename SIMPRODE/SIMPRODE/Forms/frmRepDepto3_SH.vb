...
Public Class frmRepDepto3_SH
    ...
    Private Sub frmRepDepto3_SH_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepDepto3_SH_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
    End Sub
    ...
    Private Function funImprimir()
        ...
        funPrintConSp("repComprasDepto-v1.rpt", lstParametros)
        '--
        Return True
    End Function
    ...
    Private Sub bbExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbExcel.ItemClick
        ...
        Try
            ...
            Dim strFileName As String = FilePath & "\RepDepto.xlsx"
    ...
    Private Sub funCargaData2()
        ...
        'Dim CMD As New SqlCommand("sp_RepComprasSaldosMargenDepto_v1")
        Dim CMD As New SqlCommand("sp_RepComprasSaldosMargenDepto_v1_Test_SH")
        '--
