...
Public Class frmTraslados_Open
    ...
    Private Sub frmTraslados_Open_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'funCargaData()
    End Sub
    ...
    Private Sub bbProceso_Click(sender As Object, e As EventArgs) Handles bbProceso.Click
        ...
        funGrabarOrigen()
        funGrabarDestino()
        clsTraslado.funGetTraslado(Trim(Me.txtTraslado.Text))
        '--
    End Sub
    ...
    Private Sub funGrabarDestino()
        ...
        Try
            For i = 0 To Me.gvDetalle.RowCount - 1
                ...
                funAddCampo("Posicion_Z_Codigo", "1011", "")
