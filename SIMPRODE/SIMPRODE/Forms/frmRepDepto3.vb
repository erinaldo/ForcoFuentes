...
Public Class frmRepDepto3
    ...
    Private Sub frmRepDepto3_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepDepto3_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
    End Sub
    ...
    Private Sub funCargaData2()
        ...
        Dim CMD As New SqlCommand("sp_RepComprasSaldosMargenDepto_v1_Test")
        '--
