...
Public Class frmTraslados_Entrada
    ...
    Private Sub frmTraslados_Entrada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'funCargaData()
    End Sub
    ...
    Private Sub bbProceso_Click(sender As Object, e As EventArgs) Handles bbProceso.Click
        '-- Procesar 
        funGrabarOrigen()
        clsTraslado.funGetTrasladoEntrada(Trim(Me.txtTraslado.Text))
        '--
    End Sub
