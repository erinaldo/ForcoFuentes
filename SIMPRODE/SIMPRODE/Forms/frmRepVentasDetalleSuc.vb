...
Public Class frmRepVentasDetalleSuc
    '--
    ...
    Private Sub frmRepVentasDetalleSuc_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepVentasDetalleSuc_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid_Depto()
        funUpdateGrid_Suc()
    End Sub
    ...
    Private Sub funUpdateGrid_Datos()
        ...
        Try
            ...
            funSetColumna(gvDetalle2, "DEPTO_ID", "DEPTO_ID", funIndice(), 90, 1)
            funSetColumna(gvDetalle2, "DEPTO", "DEPTO", funIndice(), 90, 1)
    ...
    Private Sub funCargaData2()
        ...
        Dim CMD As New SqlCommand("sp_RepVentasDetalle2_Porras_Consol")
        '--
