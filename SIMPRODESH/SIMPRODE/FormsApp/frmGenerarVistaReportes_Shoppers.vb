Public Class frmGenerarVistaReportes_Shoppers
    ...
    Private Sub btn_generar_Click(sender As Object, e As EventArgs) Handles btn_generar.Click
        ...
        Try
            ...
            sqlcomando.CommandText = "IF object_id('VistaCompraArticulos_Shoppers') IS NOT NULL " & _
                                       " DROP VIEW dbo.VistaCompraArticulos_Shoppers"
            sqlcomando.CommandType = CommandType.Text
            sqlcomando.Connection = Conexion
            sqlcomando.ExecuteNonQuery()
            'compras
            sqlcomando.CommandText = "CREATE VIEW dbo.VistaCompraArticulos_Shoppers" & _
     ...
     " AND bl.Detalle_Fecha <= " + com(Format(Dtp_hasta.Value, "MM/dd/yyyy"))
            ...
            sqlcomando.ExecuteNonQuery()
            'ventas
            sqlcomando.CommandText = "IF object_id('VistaMargenVentas_Shoppers') IS NOT NULL " & _
                                         " DROP VIEW dbo.VistaMargenVentas_Shoppers "
            sqlcomando.CommandType = CommandType.Text
            sqlcomando.Connection = Conexion
            sqlcomando.ExecuteNonQuery()

            sqlcomando.CommandText = "CREATE VIEW dbo.VistaMargenVentas_Shoppers" & _
...
"            GROUP BY  Articulo_Id"
            ...
            sqlcomando.CommandText = "IF object_id('SumaVentaArticulos_Shoppers') IS NOT NULL " & _
                                        " DROP VIEW dbo.SumaVentaArticulos_Shoppers "
            sqlcomando.CommandType = CommandType.Text
            sqlcomando.Connection = Conexion
            sqlcomando.ExecuteNonQuery()

            sqlcomando.CommandText = "CREATE VIEW dbo.SumaVentaArticulos_Shoppers " & _
