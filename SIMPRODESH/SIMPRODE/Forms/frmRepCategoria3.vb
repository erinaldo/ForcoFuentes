...
Public Class frmRepCategoria3
    ...
    Private Sub frmRepCategoria3_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmRepCategoria3_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        funUpdateGrid()
    End Sub

    Private Function funUpdateGrid()
        Try
            ds = clsCategoria.funListaCategoria()
    ...
    Private Function funImprimir()
        ...
        funPrintConSp("repComprasCategoria-v1.rpt", lstParametros)
        '--
        Return True
    End Function
    ...
    Private Sub funCargaData2()
        ...
        Dim CMD As New SqlCommand("sp_RepComprasSaldosMargenCategoria")
        '--
