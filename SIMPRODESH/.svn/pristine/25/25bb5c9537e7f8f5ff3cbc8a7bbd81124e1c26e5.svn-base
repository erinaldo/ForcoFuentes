...
Public Class frmRepInvBajaRota

    Dim i As Integer
    Dim dsReporte As DataSet

    Private Sub frmRepInvBajaRota_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub funCargaData()
        ...
        Dim CMD As New SqlCommand("sp_RepVentaBajoConsumoDate")
        '--
    ...
    Private Sub bbExcel_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbExcel.ItemClick
        Try
            ...
            Dim strFileName As String = FilePath & "\repInvBajaRotacion.xlsx"
