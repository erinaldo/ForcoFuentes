...
Public Class frmDespacho_Despacha
    ...
    Private Sub frmDespacho_Despacha_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmDespacho_Despacha_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        funIniVar()
        funNuevoNumero()
    ...
    Private Function funCargaCombos()
        '-- Cargar Alistadores
        strSQL = "SELECT nCodigo AS nCodigo, strData AS strDescripcion FROM GB_Chequeador ORDER BY strData"
        '--
