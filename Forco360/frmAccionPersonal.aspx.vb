...
Partial Class frmAccionPersonal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'Metodo
            CType(Me.Master, MasterCRM3).PageTitle = "Acciones de Personal"
    ...
    Private Sub funUpdateGrid()
        ...
        dt = clsAccionPersonal.funGetLista_AccionPersonal()
        With Me.gvContactos
    ...
    Protected Sub btnAdd_Click(sender As Object, e As System.EventArgs) Handles btnAdd.Click
        Response.Redirect("~/frmAccionPersonal_Add.aspx")
    End Sub
