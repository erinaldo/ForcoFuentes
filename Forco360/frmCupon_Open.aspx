<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="frmCupon_Open.aspx.vb" Inherits="frmCupon_Open" Title="Cupones" %>
                                                ...
                                                <asp:Panel ID="Panel1" runat="server" Width="800px" Height="350px" ScrollBars="Both">
                                                    <asp:GridView ID="gvContactos" runat="server" Width="800px" Height="1px" ForeColor="#333333" GridLines="None" CellPadding="4" AutoGenerateColumns="False">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="nNumero" HeaderText="Número">
                                                                <ItemStyle HorizontalAlign="Left" Width="50px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="dtmFecha" HeaderText="Fecha">
                                                                <ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="strCuponTipo" HeaderText="Tipo">
                                                                <ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="strCuponConcepto" HeaderText="Concepto">
                                                                <ItemStyle HorizontalAlign="Left" Width="300px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="strStatus" HeaderText="Estado">
                                                                <ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>
                                                            </asp:BoundField>
                                                        </Columns>
