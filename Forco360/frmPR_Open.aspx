<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="frmPR_Open.aspx.vb" Inherits="frmPR_Open" Title="Solicitudes de Proyectos" %>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="width: 70%; height: 100%" valign="top" align="left">
                                                                <asp:DropDownList ID="lkProyecto" runat="server" Font-Size="X-Small" Width="200px" ForeColor="Black" Font-Names="Arial">
                                                                </asp:DropDownList></td>
                                                ...
                                                <asp:Panel ID="Panel1" runat="server" Height="372px" ScrollBars="Both">
                                                    <asp:GridView ID="gvContactos" runat="server" Width="800px" Height="2px" ForeColor="#333333" GridLines="None" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="nNumero" HeaderText="No.">
                                                                <ItemStyle HorizontalAlign="Left" Width="10px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="dtmFecha" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}">
                                                                <ItemStyle HorizontalAlign="Left" Width="20px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="strEstado" HeaderText="Estado">
                                                                <ItemStyle HorizontalAlign="Left" Width="20px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="strUserAdd" HeaderText="Solicitante">
                                                                <ItemStyle HorizontalAlign="Left" Width="20px" />
                                                            </asp:BoundField>
