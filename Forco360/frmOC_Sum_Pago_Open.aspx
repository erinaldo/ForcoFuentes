<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="frmOC_Sum_Pago_Open.aspx.vb" Inherits="frmOC_Sum_Open" Title="Contactos Cliente" %>
                                                ...
                                                <asp:Panel ID="Panel1" runat="server" Height="372px" ScrollBars="Both">
                                                    <asp:GridView ID="gvContactos" runat="server" Width="800px" Height="1px" ForeColor="#333333" GridLines="None" CellPadding="4" AutoGenerateColumns="False">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="strPago_Status" HeaderText="Estado">
                                                                <ItemStyle HorizontalAlign="Left" Width="5px" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="dtmFecha_SolPago" HeaderText="F.S.Pago" DataFormatString="{0:dd/MM/yyyy}">
                                                                <ItemStyle HorizontalAlign="Left" Width="20px"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="dtmFecha_SolPagoAuto" HeaderText="F.A.Pago" DataFormatString="{0:dd/MM/yyyy}">
                                                                <ItemStyle HorizontalAlign="Left" Width="20px"></ItemStyle>
                                                            </asp:BoundField>
                                                        </Columns>
