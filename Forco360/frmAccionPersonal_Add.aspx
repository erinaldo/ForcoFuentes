<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="False" CodeFile="frmAccionPersonal_Add.aspx.vb"
    Inherits="frmAccionPersonal_Add" Title="Contactos Cliente" %>
                    ...
                    <tr>
                        <td style="width: 100%; height: 100%" align="left" valign="top" bgcolor="#CC0000">
                            <asp:Button ID="btnSave" runat="server" BackColor="Gray" BorderStyle="Outset" ForeColor="White"
                                Text="Guardar" Height="30px" BorderColor="#404040" CssClass="Tooltip_Table" Font-Size="10pt"
                                Width="90px" />
                                                    ...
                                                    <td class="auto-style2" style="width: 300px">
                                                     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        ...
                                                        <jmcb:MultiComboBox ID="mcboEmpleado" runat="server" DataValueField="ID" Height="34px"
                                                            ...
                                                            LayoutWidth="600" MaximumEntries="50" AutoPostBack="False">
                                                            <columns>
