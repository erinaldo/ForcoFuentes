...
Partial Class frmOC_Sum_Open
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            'Metodo
            CType(Me.Master, MasterCRM3).PageTitle = ":: Solicitud Pago de Suministros ::"
    ...
    Private Sub funUpdateGrid_Back()
        ...
        '--
        dt = clsOrdenCompra.funGetLista_Orden_Compra_Solicitud_Pago_LD(Session("Proveedor"), Session("Estado"), Me.Session("dtmFecha_Inicio"), Session("dtmFecha_Final"))
        With Me.gvContactos
    ...
    Private Sub funUpdateGrid()
        '-- 
        dt = clsOrdenCompra.funGetLista_Orden_Compra_Solicitud_Pago_LD(lkProveedor.SelectedValue, lkEstado.SelectedItem.Value, dtpInicio.Value, dtpFinal.Value)
        With Me.gvContactos
            .DataKeyNames = New String() {"Orden_Id"}
            .EmptyDataText = "Actualmente no hay Ordenes de Compra con los filtros seleccionados"
            .DataSource = dt
    ...
    Protected Sub gvContactos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvContactos.RowDataBound
        ...
        If nRol = 1 Then
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                CType(e.Row.Cells(0).Controls(0), HyperLink).NavigateUrl = String.Concat("~/frmOC_Sum_Pago_Data.aspx?nOrden=", Orden_Id)
                CType(e.Row.Cells(0).Controls(0), HyperLink).ToolTip = "Solicitar"
                CType(e.Row.Cells(0).Controls(0), HyperLink).ImageUrl = "images/edit_icon.gif"
                '-- Autoriza
                CType(e.Row.Cells(1).Controls(0), HyperLink).NavigateUrl = String.Concat("~/frmOC_Sum_Pago_Auto.aspx?nOrden=", Orden_Id)
