<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="frmOC_Sum_Pago_Auto.aspx.vb"
                    ...
                    <tr>
                        <td style="width: 100%; height: 100%" align="left" valign="top" bgcolor="#339966">
                            <asp:Button ID="btnRegresar" runat="server" BackColor="Gray" BorderStyle="Outset"
                                ...
                                Width="80px" />
                            <asp:Button ID="btnAutorizar" runat="server" BackColor="Gray" BorderStyle="Outset"
                                ForeColor="White" Text="Autorizar" Height="30px" BorderColor="#404040" CssClass="Estilo_Boton"
                                Width="80px" />
                            <asp:Button ID="btnRechazar" runat="server" BackColor="Gray" BorderStyle="Outset"
                                ForeColor="White" Text="Rechazar" Height="30px" BorderColor="#404040" CssClass="Estilo_Boton"
                                Width="80px" />
