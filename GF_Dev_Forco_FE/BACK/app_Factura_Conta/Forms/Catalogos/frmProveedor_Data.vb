...
Public Class frmProveedor_Data
    ...
    Private Sub frmPersonas_Data_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyData = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmPersonas_Data_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        bolInicio = True
        If nTipo = 1 Then
            funCargaCombos()
            funDesactivaNatural()
    ...
    Private Function funCargaData()
        ...
        strSQL = "SELECT * FROM Gen_Clientes " & _
    ...
    Private Function ValidarNatural() As Boolean
        If Len(Trim(Me.lblCodigo.Text)) = 0 Then
            Me.lblCodigo.Focus()
            MsgBox("Falta Codigo de Proveedor !!!", MsgBoxStyle.Critical, "Atención !!!")
            Return False
    ...
    Private Function funSaveNatural() As Boolean
        ...
        Try
            ...
            With dsAgregar.Tables(0).Rows(0)
                ...
                funParametrosGrabacionTransaccion("Gen_Clientes", strLlave, intTipoRegistro, vnRecno)
                '--
