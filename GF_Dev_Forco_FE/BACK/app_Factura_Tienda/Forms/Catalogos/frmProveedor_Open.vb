...
Public Class frmProveedor_Open
    ...
    Private Sub frmPersonas_Open_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        bolTipoBusqueda = False
        funUpdateGrid()
        bolTipoBusqueda = True
        Me.txtNombre.Focus()
    ...
    Private Function funUpdateGrid() As Boolean
        ...
        If bolTipoBusqueda = True Then
            '--
            strSQL = "SELECT * FROM v_Gen_Clientes_All "
        ...
        Else
            '--
            strSQL = "SELECT TOP 100 * FROM v_Gen_Clientes_All " & _
                     " ORDER BY nPersona"
            '--
        End If
        '--
