...
Public Class frmCliente_Data
    ...
    Private Function funCargaData()
        ...
        If vnTipoPersona = 1 Then
            ...
            Me.txtCorreo.Text = ds.Tables(0).Rows(0)("strCorreo").ToString
        Else
            '-- Persona Juridica
            ...
            Me.txtCorreo2.Text = ds.Tables(0).Rows(0)("strCorreo").ToString
        End If
    ...
    Private Function ValidarNatural() As Boolean
        ...
        ElseIf Len(Trim(Me.txtApellido1.Text)) = 0 Then
            ...
            Return False
        ElseIf Len(Trim(Me.txtCorreo.Text)) = 0 Then
            Me.txtApellido1.Focus()
            MsgBox("Falta Correo Electronico !!!", MsgBoxStyle.Critical, "Atención !!!")
            Return False
        End If
        '--
        Return True
        ...
        Try
            ...
            With dsAgregar.Tables(0).Rows(0)
                ...
                If intTipoRegistro = 1 Then
                    ...
                    funAddCampo("strCorreo", Trim(Me.txtCorreo.Text), "")
                Else
                    '-- Editando
    ...
    Private Function funSaveJuridico() As Boolean
        ...
        With dsAgregar.Tables(0).Rows(0)
            ...
            If intTipoRegistro = 1 Then
                ...
                funAddCampo("strUserAdd", strUser, "")
                funAddCampo("strUserUpdate", strUser, "")
                funAddCampo("strCorreo", Trim(Me.txtCorreo2.Text), "")
