...
Public Class frmFactura_Open
    ...
    Private Function funUpdateGrid() As Boolean
        ...
        funSetColumna(GridView1, "ESTADO", "ESTADO", funIndice(), 80, 1)
        '--
        Return True
    End Function
    ...
    Private Sub subPrint()
        ...
        '-- 
        lstParametros.Add(Me.GridView1.GetFocusedRowCellValue("CONSECUTIVO").ToString)
        '--
        funPrintConSp("repFacturaFE_General.rpt", lstParametros)
